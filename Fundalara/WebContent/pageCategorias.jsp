				...
				<div class="art-sheet-body">
					...
					<div class="art-nav">
						...
						<div class="art-nav-center">
							<ul class="art-menu">
								<li><a class="active" href="page.jsp"><span class="l"></span><span
									...
									<div class="art-block-body">
										...
										<img src="Recursos/Imagenes/calendario.png"> <br> <br>
													...
													<div class="art-blockheader">
														<div class="l"></div>
														<div class="r"></div>
														<h3 class="t">Estad&iacute;sticas</h3>
																	...
																	<div class="art-blockcontent-body">
																		<form name="form2" method="post" action="index.php">
																			<table class="poll" align="center" border="0"
																				...
																				<thead>
																					<tr>
																						<td style="font-weight: bold;">&iquest;En
																							qu&eacute; categor&iacute;a desea inscribir a su
																							hijo?</td>
																					</tr>
																				</thead>
																				<tbody>
