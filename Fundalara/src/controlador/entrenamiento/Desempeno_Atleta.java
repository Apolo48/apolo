...
import controlador.entrenamiento.modelos.Listener;
import controlador.entrenamiento.modelos.ModeloListBox;
import controlador.entrenamiento.modelos.Render;
...
public class Desempeno_Atleta extends GenericForwardComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		escuchador = new Listener(lista,chcGeneral);
	...
	public Listener getEscuchador() {
		return escuchador;
	}



	public void setEscuchador(Listener escuchador) {
