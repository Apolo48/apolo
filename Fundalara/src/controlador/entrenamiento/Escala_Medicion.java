...
public class Escala_Medicion extends GenericForwardComposer {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		TipoDato td = servicioTipoDato.buscarTipo("tipoescala");
...
//		servicioValorEscalaMedicion.agregar(valor);
	...
	public void onClick$btnQuitar() {
		...
		while (i <= lista.size()) {
			if ((lista.get(i).getEscalaMedicion().getCodigoEscala() == escala
					.getCodigoEscala())
					&& lista.get(i).getNombre() == lbValoresEscala
	...
	public void onChange$cmbEscala() {
		...
		ValorEscala v;
		for (Object o: escala.getValoresEscala()) {
			v=(ValorEscala)o;
			Listitem nvoItem = new Listitem();
			nvoItem.appendChild(new Listcell(v.getNombre()));
