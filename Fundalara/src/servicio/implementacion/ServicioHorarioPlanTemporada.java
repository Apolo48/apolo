...
/*	public Boolean compararRangoHoras(PlanTemporada planTemporada, Date hIni,
			Date hFin) {
		return daoHorarioPlanTemporada.compararRangoHoras(planTemporada, hIni,
				hFin);
	}*/

	public int generarCodigo() {
		return daoHorarioPlanTemporada
				.generarCodigo(HorarioPlanTemporada.class);
	}

/*	public List<HorarioPlanTemporada> listarPorPlanTemporadaEquipo(
			PlanTemporada planTemporada, Equipo equipo) {
		return daoHorarioPlanTemporada.listarDosCamposActivos(
				HorarioPlanTemporada.class, "planTemporada", planTemporada,
				"equipo", equipo);
	}*/
